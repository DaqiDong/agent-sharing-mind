...
import myagent.modules.WaterEnvironment;
 ...
 */
public class WaterEnvironmentPanel extends GuiPanelImpl {

    private static final Logger logger = Logger.getLogger(WaterEnvironmentPanel.class.getCanonicalName());
    private WaterEnvironment environment;
    private BufferedImage img = new BufferedImage(WaterEnvironment.ENVIRONMENT_WIDTH,
            WaterEnvironment.ENVIRONMENT_HEIGHT, BufferedImage.TYPE_INT_RGB);

    /** Creates new form WaterEnvironmentPanel */
    public WaterEnvironmentPanel() {
        initComponents();
    }
    ...
    public void initPanel(String[] param) {
        environment = (WaterEnvironment) agent.getSubmodule(ModuleName.Environment);
        if (environment != null) {
            refresh();
        } else {
