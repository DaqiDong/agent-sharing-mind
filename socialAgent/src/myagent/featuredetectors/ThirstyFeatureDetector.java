 ...
 * @author Daqi
 */
public class ThirstyFeatureDetector extends BasicDetectionAlgorithm{
    private static final Logger logger = Logger.getLogger(ThirstyFeatureDetector.class.getCanonicalName());
