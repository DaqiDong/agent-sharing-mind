 ...
 * @author Ryan McCall
 */
public class WaterEnvironment extends EnvironmentImpl {

    private static final Logger logger = Logger.getLogger(WaterEnvironment.class.getCanonicalName());
    ...
    public void driveEnvironment() {
        ...
        switch (randomValue) {
            case 0:
                ...
                logger.log(Level.FINE, "Water (Blue square) displayed.", TaskManager.getCurrentTick());
                break;
            case 1:
                clearImage();
                g.setColor(Color.RED);
                g.fillRect(upperLeftX, upperLeftY, objectSizeX, objectSizeY);
                logger.log(Level.FINE, "Apple (Red cicle) displayed!", TaskManager.getCurrentTick());
                break;
            case 2:
                clearImage();
